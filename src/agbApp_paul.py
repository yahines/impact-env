...
if selected_menus:
    ...
    selected_groupes = st.segmented_control("Groupes d'aliments", groupes.tolist(), selection_mode="multi", label_visibility="hidden")
...
# TODO input pour liste de types confondus 
    if selected_groupes:
        ...
        selected_types = st.segmented_control("Types d'aliments", types.tolist(), selection_mode="multi", label_visibility="hidden")
...
# TODO selectionner dans liste des type de cuisson
        if selected_types:
            ...
            selected_preparations = st.segmented_control("Modes de préparation", preparations.tolist(), selection_mode="multi", label_visibility="hidden")
